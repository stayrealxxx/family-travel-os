const CACHE='family-travel-os-v31';
const CORE=['./','./index.html','./styles-v1.css','./manifest.webmanifest','./christmas-icon.svg','./plan-data-v1.js','./app-core-v3.js','./weather-v4.js','./trip-data.json'];
