const CACHE='family-travel-os-v30';
const CORE=['./','./index.html','./styles-v1.css','./manifest.webmanifest','./christmas-icon.svg','./plan-data-v1.js','./app-core-v2.js','./weather-v4.js','./trip-data.json'];
