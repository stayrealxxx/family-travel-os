const CACHE='family-travel-os-v18';
const CORE=['./','./index.html','./manifest.webmanifest','./christmas-icon.svg','./trip-data.json','./countdown-lab.js','./weather.js','./site-theme.js','./app-live.js'];
