const CACHE='family-travel-os-v21';
const CORE=['./','./index.html','./manifest.webmanifest','./christmas-icon.svg','./trip-data.json','./countdown-lab.js','./weather.js','./site-theme.js','./app-live.js','./preferences-v3.js'];
